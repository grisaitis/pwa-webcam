...
function runTests() {
  ...
  if (!navigator) {
    outputTest('navigator: Error, browser not supported.', codes.error);
    returnCode = codes.error;
  } else {
    outputTest('navigator: Success.', codes.ok);
  }

  if (!navigator.mediaDevices) {
    outputTest('navigator.mediaDevices: Error, browser not supported.', codes.error);
    returnCode = codes.error;
  } else {
    outputTest('navigator.mediaDevices: Success.', codes.ok);
  }

  if (!navigator.mediaDevices.getUserMedia) {
    outputTest('navigator.mediaDevices.getUserMedia: Error, browser not supported.', codes.error);
    returnCode = codes.error;
  } else {
    outputTest('navigator.mediaDevices.getUserMedia: Success.', codes.ok);
  }
